...
export const appConfigs: Record<AppID, AppConfig> = {
	'file-explorer': { id: 'file-explorer', title: 'File Explorer', icon: '📁', defaultWidth: 900, defaultHeight: 600, minWidth: 400, minHeight: 300, pinned: true },
	edge: { id: 'edge', title: 'Microsoft Edge', icon: '🌐', defaultWidth: 1000, defaultHeight: 700, minWidth: 500, minHeight: 400, pinned: true },
	settings: { id: 'settings', title: 'Settings', icon: '⚙️', defaultWidth: 900, defaultHeight: 620, minWidth: 400, minHeight: 300, pinned: false },
	notepad: { id: 'notepad', title: 'Notepad', icon: '📝', defaultWidth: 700, defaultHeight: 500, minWidth: 300, minHeight: 200, pinned: false },
	terminal: { id: 'terminal', title: 'Terminal', icon: '💻', defaultWidth: 800, defaultHeight: 500, minWidth: 400, minHeight: 250, pinned: true },
	...
	mail: { id: 'mail', title: 'Mail', icon: '📧', defaultWidth: 900, defaultHeight: 620, minWidth: 500, minHeight: 400, pinned: true },
	calendar: { id: 'calendar', title: 'Calendar', icon: '📅', defaultWidth: 850, defaultHeight: 580, minWidth: 500, minHeight: 400, pinned: false },
